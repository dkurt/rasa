...
```bash
pip3 install --no-deps defusedxml openvino-dev
pip3 install rasa[openvino]
```

This will install packages for language models conversion into OpenVINO IR format and the runtime.
